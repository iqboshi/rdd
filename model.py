...
class QueryMaskHead(nn.Module):
    def __init__(
        ...
        self.order_embed = nn.Linear(hidden_dim, 1)
    ...
    def forward(self, mask_feature: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        pred_order = self.order_embed(q).squeeze(-1)  # [B, Q]
        ...
        return {"pred_logits": pred_logits, "pred_masks": pred_masks, "pred_order": pred_order}
...
class LeafInstanceSegModel(nn.Module):
    ...
    def forward(self, image: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        out_dict = {
            ...
            "pred_order": head_out["pred_order"],
        }
...
if __name__ == "__main__":
    ...
    print("pred_order.shape:", out["pred_order"].shape)
